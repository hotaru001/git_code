...
#include "doubleWin.h"
doubleWin::doubleWin(int x, int y, int w, int h) :CWinBase(x, y, w, h)
{
...
void doubleWin::insert_into_orders(const char* username, int i, double price)
{
    char sql[1024];
